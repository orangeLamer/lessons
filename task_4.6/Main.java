...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.print(
                "сообщение для объекта gosha: \nМеня зовут "+gosha.getName()+"\nИмя моей мамы: "
                +gosha.getMother().getName()+"\nИмя моего папы: "+gosha.getFather().getName()+
                "\nУ меня две бабушки, бабушка "+gosha.getMother().getMother().getName()+" и "
                        +gosha.getFather().getMother().getName()+
                "\nУ меня два деда, деда "+gosha.getFather().getFather().getName()+" и "
